...
uint8_t isButtonPressed(uint8_t index){				// các nút nhấn tương ứng đã được nhấn chưa
...
void button_reading(){
	for (int index = 0; index < BUTTON_NUM; index++){				// chống rung cho tấn cả nút nhấn được khai báo
